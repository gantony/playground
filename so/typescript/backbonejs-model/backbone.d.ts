...
declare module Backbone {
    ...
    /* PILZ ADDITIONS*/
    interface SetOptions extends Silenceable {
        add?: boolean;
        remove?: boolean;
        merge?: boolean;
    }
    ...
    class Collection extends ModelBase {
        ...
        /* PILZ ADDITIONS */
        set(model: Model, options?: SetOptions);
        set(models: Model[], options?: SetOptions);
        /* PILZ ADDITIONS */
        get(id: any): Model;
        ...
        /* PILZ ADDITIONS */
        groupBy(iterator: string): any[];
        groupBy(iterator: (element: Model, index: number) => boolean, context?: any): any[];
        /* PILZ ADDITIONS */
...
/*
    ...
    class Router extends Events /* PILZ MODIFICATION -  implements OptionalRoutes */ {
